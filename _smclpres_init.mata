...
void smclpres:: new() {
	...
	option_parse.put(("toc",       "nosubtitlebhline"  ), &p_hline())
	...
	option_parse.put(("toc",       "subtitlepos"       ), &p_pos())
	...
	option_parse.put(("topbar",    "nothline"          ), &p_hline())
	option_parse.put(("topbar",    "nobhline"          ), &p_hline())
	...
	option_parse.put(("bottombar", "nothline"          ), &p_hline())
	option_parse.put(("bottombar", "nobhline"          ), &p_hline())
	...
	option_parse.put(("bottombar", "next"              ), &p_pos())
	...
	option_parse.put(("title",     "thline"            ), &p_hline())
	option_parse.put(("title",     "bhline"            ), &p_hline())
	option_parse.put(("title",     "nobold"            ), &p_font())
	option_parse.put(("title",     "italic"            ), &p_font())
	option_parse.put(("title",     "left"              ), &p_pos())
